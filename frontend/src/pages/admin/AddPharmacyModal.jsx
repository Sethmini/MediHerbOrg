...
const DraggableMarker = ({ position, setPosition }) => {
  ...
  return (
    <Marker draggable={true} eventHandlers={eventHandlers} position={position} ref={markerRef}>
      <Popup>Drag to set pharmacy location</Popup>
    </Marker>
  );
};

const AddPharmacyModal = ({ show, handleClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await AxiosInstance.post('/pharmacies', payload);
      ...
      console.error('Error adding pharmacy:', err.response?.data || err.message);
      setError(err.response?.data?.message || 'Failed to add pharmacy. Please try again.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <Modal.Body>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <div className="d-flex justify-content-end">
            ...
            >
              {loading ? <Spinner animation="border" size="sm" /> : 'Add Pharmacy'}
            </Button>
          </div>
        </Form>
      </Modal.Body>
